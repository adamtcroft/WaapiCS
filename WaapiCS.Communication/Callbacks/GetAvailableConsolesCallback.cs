...
namespace WaapiCS.Communication
{
    ...
    public class GetAvailableConsolesCallback : Callback
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailableConsolesCallback"/> class.
        /// </summary>
        ...
        public GetAvailableConsolesCallback (Packet packet) : base(packet)
        {
        ...
        public override void Result<TMessage>(IWampFormatter<TMessage> formatter, ResultDetails details, TMessage[] arguments, IDictionary<string, TMessage> argumentsKeywords)
        {
            ...
            _packet.results = formatter.Deserialize<List<dynamic>>(argumentsKeywords["consoles"]);
