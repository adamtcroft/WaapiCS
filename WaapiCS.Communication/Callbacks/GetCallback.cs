...
{
    /// <summary>
    /// The callback object for ak.wwise.core.object.get
    /// </summary>
    /// <seealso cref="WaapiCS.Communication.Callback" />
    public class GetCallback : Callback
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCallback"/> class.
        /// </summary>
        ...
        public GetCallback(Packet packet) : base(packet)
        {
