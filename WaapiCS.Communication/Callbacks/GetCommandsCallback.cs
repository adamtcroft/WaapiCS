...
{
    /// <summary>
    /// The callback object for ak.wwise.ui.commands.getCommands
    /// </summary>
    /// <seealso cref="WaapiCS.Communication.Callback" />
    public class GetCommandsCallback : Callback
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCommandsCallback"/> class.
        /// </summary>
        ...
        public GetCommandsCallback (Packet packet) : base(packet)
        {
        ...
        public override void Result<TMessage>(IWampFormatter<TMessage> formatter, ResultDetails details, TMessage[] arguments, IDictionary<string, TMessage> argumentsKeywords)
        {
            ...
            string[] commands = formatter.Deserialize<string[]>(argumentsKeywords["commands"]);

            // Add each command to a List<string>
            foreach (string command in commands)
                _packet.results.Add(command);
